import { IsEmail, IsNotEmpty, MaxLength, Length, Validate, Matches } from "class-validator"
import {
...
export class CreateUserDTO {
    ...
    @Matches(/^[a-zA-Z0-9_.-]+$/, {message: 'username must contain letters, numbers, underscore, dash, and dot'})
    @Length( 5, 20 )
    @IsNotEmpty()
    username: string
